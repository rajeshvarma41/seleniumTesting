...
//Test cases are run parallelly using testng5.XML using tag <suite name="Suite" parallel="tests">
//Here we are running the test cases from testng4.xml right click->Run as Test Suite-- in this cases test cases are run serially
...
public class RunParallelTestNG {
